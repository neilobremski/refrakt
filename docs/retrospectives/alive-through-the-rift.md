...
The cover art was created by Neil — a robot silhouette against a fractured sky with glowing interdimensional rifts. The image captures the story's central tension: a solitary figure standing between worlds, reaching toward something beyond.

This album predated the DALL-E integration — art generation was added to the pipeline afterward, inspired by the need to automate this step for future albums.
